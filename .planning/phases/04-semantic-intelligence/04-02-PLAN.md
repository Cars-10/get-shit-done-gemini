...
Purpose: Provide Gemini with actionable intelligence - dependency hotspots, file purposes, and relationship awareness at session start.
...
- Injects content as <codebase-intelligence> tag into Gemini's context
...
```bash
cd /Users/lexchristopherson/Developer/gemini-cli-resources/get-shit-done
