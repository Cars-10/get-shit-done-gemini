...
- Reference template for issues format: `@~/.gemini/get-shit-done/templates/uat-issues.md`
...
- Update execution_context to reference workflow: `@~/.gemini/get-shit-done/workflows/verify-work.md`
- Add template reference: `@~/.gemini/get-shit-done/templates/uat-issues.md`
